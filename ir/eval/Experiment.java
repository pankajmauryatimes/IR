...
public class Experiment {
   ...
   */
  public Experiment(File corpusDir, File queryFile, File outFile, short docType, boolean stem, boolean pseudofeedback, int pseudoDocsNum, double a, double b, double g)
      throws IOException {
    this.corpusDir = corpusDir;
    this.index = new InvertedIndex(corpusDir, docType, stem, false, pseudofeedback, pseudoDocsNum, a, b, g
);
  ...
  public static void main(String[] args) throws IOException {
    ...
    Experiment exper = new Experiment(new File(corpusDir), new File(queryFile),
        new File(outFile), docType, stem, pseudofeedback, pseudoDocsNum, a, b, g);
    exper.makeRpCurve();
  }
}
